...
const errorCodes = {
	...
	NotConnectedOrBlocked:
		'You may not be connected to the internet, or an ad blocking or privacy extension may be blocking Bungie.net.',
	...
	DestinyLegacyPlatform:
		"Bungie's services currently have a bug that prevents D2 Recommended from loading info for your Destiny 2 account if you played Destiny 1 on a last-gen console. Bungie will fix this soon, but until then you must play Destiny 1 on a current-gen console to be able to access your info.",
	DevVersion:
		'Are you running a development version of D2 Recommended? You must register your chrome extension with Bungie.net.',
...
export class RecommendedError extends Error {
	...
	public constructor(
		...
		const message =
			typeof messageTmp === 'function'
				? (messageTmp as (...args: unknown[]) => string)(...args)
				: messageTmp;
		super(message);
	}
